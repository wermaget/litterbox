        ...
        <div class="card-box">
            ...
            <div class="table-responsive">
                <table class="table table-hover m-0 table-actions-bar">
                    ...
                    <?php } ?>
                    <tr>
                        <td colspan="3"><a href="?view=jobList&isApproved=0">
                                <button class="btn-sm btn-blue">View all</button>
                            </a>
                    </tr>
                    </tbody>
                </table>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="table-action-btn"
                                   href="?view=invoiceDetail&Id=<?= $row->timesheetId; ?>">view</a>
                            </td>
                        </tr>
                    <?php } ?>
                    <tr>
                        <td colspan="3"><a href="?view=invoiceList">
                                <button class="btn-sm btn-blue">View all</button>
                            </a>
                    </tr>
                    </tbody>
