...
<div class="row">
    <div class="col-sm-7 center-page">
        <form action="process.php?action=create" method="POST" id="default-wizard" data-parsley-validate="" style="margin-bottom: 70px;">
                ...
                <div>
                    <div>
                        ...
                        <div class="row">
                            <div class="p-r-10 w-50-p pull-left">
                                <div class="form-group">
                                    <div class="truncate-xs"><label for="username">Company Representative Position <span
                                                    style="color: red;">*</span></label></div>
                        ...
                        <div class="row">
                            <div class="p-r-10 w-50-p pull-left">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="" id="ltr3" data-mask="9999" class="form-control"
