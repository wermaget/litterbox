...
<div class="page-main wrapper">
    ...
    <footer>
        ...
        <div class="container-fluid"
             style="padding: 30px 60px 10px 45px; color: #FFFFFF; background-color: #000; bottom: 0;" id="con">
            <div class="row center-page container">
                <div class="container-fluid col-12 col-lg-2">
                    <a class="footer-logo"><img src=""/></a>
                        ...
                        <form id="default-wizard" action="process.php?action=sendInquiry" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-lg-3">
                                        <button type="submit" class="btn-sm btn-blue stepy-finish pull-right"> SUBMIT
                                        </button>
                                    </div>
                                </div>
                        </form>
