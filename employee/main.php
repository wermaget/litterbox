            ...
            <div class="col-sm-12">
                <center>
                    ...
                    <?php if ($app->status == $break || $app->status == $break2 || $app->status == $lunch) { ?>
                        <a href="process.php?action=stampCheckIn" class="btn btn-primary"><span
                                    class="fa fa-clock-o"></span>Login</a>
                    <?php } else { ?>
                    ...
                    <?php if ((!$app->breakOut || !$app->breakOut2) && $app->status == $login) { ?>
                        <?php if (!$app->breakOut) { ?>
                            <a href="process.php?action=stampBreak" class="btn btn-warning"><span
                                        class="fa fa-clock-o"></span>Break</a>
                        <?php } else { ?>
                            <a href="process.php?action=stampBreak2" class="btn btn-warning"><span
                                        class="fa fa-clock-o"></span>Break</a>
                        <?php } ?>
                    <?php } else { ?>
                    ...
                    <?php if (!$app->lunchOut && $app->status == $login) { ?>
                        <a href="process.php?action=stampLunch" class="btn btn-warning"><span
                                    class="fa fa-clock-o"></span>Lunch</a>
                    <?php } else { ?>
                        <button class="btn btn-default" disabled><span class="fa fa-clock-o"></span>Lunch</button>
                    <?php } ?>
                    |
                    <?php if (!$app->checkOut && $app->status == $login) { ?>
                        <a href="process.php?action=stampCheckOut" class="btn btn-danger"><span
                                    class="fa fa-clock-o"></span>Logout</a>
                    <?php } else { ?>
